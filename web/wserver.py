    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/include_i0stream">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/arkonn/Ark-Mirror"><i class="fab fa-github"></i></a>
        <a href="https://t.me/include_i0stream"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
